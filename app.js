    ...
    const proceedWithDraw = async () => {
        ...
        try {
            ...
            setTimeout(async () => {
                ...
                // Muat ulang data dashboard untuk refresh tombol dan info pemenang
                loadDashboardData();
            }, 4500);
...
function initPesertaPage() {
    ...
    form?.addEventListener('submit', async (e) => {
        ...
        try {
            const dataToSave = { nama: optimisticData.nama, status_bayar: optimisticData.status_bayar, status_menang: optimisticData.status_menang, aktif: true };
            if (id) {
